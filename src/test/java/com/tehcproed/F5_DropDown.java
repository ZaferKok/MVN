...
public class F5_DropDown {
    ...
    public void dropdownTest(){
        ...
        //3.Select and Print Option 1 by visible text
                        //If you know the name of the dropdown option, how do you select that element.
                        //Let's say the name of the option is Flower, then tell me how you can select that element
